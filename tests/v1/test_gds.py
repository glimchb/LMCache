...
from lmcache.v1.memory_management import CuFileMemoryAllocator, HipFileMemoryAllocator, MemoryFormat
...
def test_gds_backend_sanity():
    ...
    try:
        ...
        assert isinstance(gds_backend.memory_allocator, (CuFileMemoryAllocator, HipFileMemoryAllocator))
